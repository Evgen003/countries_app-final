                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              if (passwordControllerReg.text.trim() ==
                                  confirmPasswordControllerReg.text.trim()) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                        'Passwords don\'t match! Please check the input.'),
...
final TextEditingController confirmPasswordControllerReg =
